...
{
    private B_OrderBaseField fieldBll = new B_OrderBaseField();
    private B_Product proBll = new B_Product();
    private B_Cart cartBll = new B_Cart();
   ...
   //小计
    public string GetPrice()
    {
        ...
        double price = Convert.ToDouble(Eval("LinPrice") == DBNull.Value ? -1 : Eval(field));
