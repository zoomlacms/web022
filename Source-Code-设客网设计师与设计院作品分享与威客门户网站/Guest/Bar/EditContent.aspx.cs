...
public partial class Guest_Bar_EditContent :CustomerPageAction
{
    ...
    private string forwardTlp = "<i class='fa fa-share-alt'></i>来自社区[<a href='{4}' target='_blank'>{3}</a>]的分享：<strong>{0}</strong> <a href='{1}' target='_blank'>{2}</a>";
    //需要返回的贴子ID
    public int PostID 
    {
