<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" inherits="ZoomLa.WebSite.Manage.Template.labelSqlOne, App_Web_mq0353cm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td colspan="2" align="center"><%--<asp:DropDownList ID="DropDownList4" runat="server" AutoPostBack=true OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged">
                ...
                <input id="buttons" name="buttons" type="button" value="可视化预览" class="btn btn-primary" onclick="createEditor()" />
