<%@ page language="C#" autoeventwireup="true" inherits="manage_Zone_AddSchool, App_Web_ikj1rj5m" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	<tr>
		<td class="td_m text-right"><strong>学校名称:</strong></td>
		<td>
	...
	<%--<tr>
		<td class="text-right"><strong>所属国家:</strong></td>
		<td>
	...
	<tr>
		<td class="text-right"><strong>所属省市:</strong></td>
		<td>
	...
	<tr>
		<td class="text-right"><strong>学校类型:</strong></td>
		<td>
	...
	<tr>
		<td class="text-right"><strong>学校性质:</strong></td>
		<td>
    ...
    <tr>
        <td class="text-right"><strong>学校微标:</strong></td>
        <td>
	...
	<tr>
		<td class="text-right"><strong>学校信息:</strong></td>
		<td>
