<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Pay.PaymentList, App_Web_nbndfeoy" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:LinkButton runat="server" CommandName="Del" OnClientClick="return confirm('是否确定删除?')" CommandArgument='<%#Eval("PaymentID") %>'><span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                    <a href="DepostDetail.aspx?ID=<%#Eval("PaymentID") %>"><span class="glyphicon glyphicon-globe"></span> 浏览</a>
                </td>
            </tr>
        </ItemTemplate>
