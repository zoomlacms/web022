<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_QuestionManage, App_Web_apw4n2f5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div id="BreadDiv" class="container-fluid mysite" style="margin-bottom: 10px;">
        <div class="row">
            <ol class="breadcrumb navbar-fixed-top">
                ...
                <li><a href="QuestionManage.aspx">考试管理</a></li>
                <li><a href="Papers_System_Manage.aspx">试卷标题：</a><asp:Label runat="server" ID="PTitle_L"></asp:Label><a href='javascript:;' onclick='SelQuestion()'>[选择试题]</a></li>
            </ol>
        </div>
    </div>
