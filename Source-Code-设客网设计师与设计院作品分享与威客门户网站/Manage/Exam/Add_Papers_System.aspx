<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Add_Papers_System, App_Web_apw4n2f5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr class="tdbg">
            ...
            <td>
                <asp:DropDownList ID="PaperClass_Drop" DataValueField="ID" DataTextField="TypeName" runat="server" CssClass="form-control text_md"></asp:DropDownList>
            </td>
        </tr>
        <tr>
