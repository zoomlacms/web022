<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Question_AddEngLishQuestion, App_Web_apw4n2f5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tbody id="basic" class="tab-pane active">
            ...
            <tr runat="server" style="display:none;" id="nodetr">
                ...
                <td>
                      <div class="btn-group Quesst_Dr">
                        <button type="button" style="text-align:left;" class="btn btn-default dropdown-toggle text-left text_300"><span class="curquest"><span class="gray_9"><i class="fa fa-warning"></i>点击选择类别!</span></span> <span class="pull-right"><span class="caret"></span></span></button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HiddenField ID="Knows_Hid" runat="server" />
                </td>
            </tr>
            <tr>
                <td>分数:</td>
