<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_Exam_KnowledgeManage, App_Web_apw4n2f5" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:Repeater ID="RPT" runat="server">
        <ItemTemplate>
            <tr data-layer="1" data-id='<%#Eval("k_id") %>'>
                ...
                <td><%#Eval("k_id") %></td>
                <td onclick="ShowChild(this);" data-child="<%#Eval("ChildCount") %>"><a href='javascript:;'><span data-type='icon' class='<%#GetIcon() %>'></span></a> <a href='AddKnowledge.aspx?id=<%# Eval("k_id")%>'><%#Eval("k_name") %></a></td>
    ...
    <script>
        ...
        function GetOption(id) {
            ...
            return "<a href='AddKnowledge.aspx?id="+id+"' title='修改'><span class='glyphicon glyphicon-pencil'></span></a> "
               ...
               +"<a href='AddKnowledge.aspx?nid=<%=NodeID %>&pid="+id+"'>添加知识点</a>";
        }
