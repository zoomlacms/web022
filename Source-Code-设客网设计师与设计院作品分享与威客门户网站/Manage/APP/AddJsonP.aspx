<%@ page language="C#" autoeventwireup="true" inherits="Manage_APP_AddJsonP, App_Web_krmjq4vt" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            <td>主表名：</td>
            <td>
                <asp:TextBox runat="server" ID="T1_T" MaxLength="50" CssClass="form-control text_300" /><span class="rd_green">主表别名为A</span>
