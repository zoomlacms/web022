<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_AddUcenter, App_Web_krmjq4vt" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
     ...
     <table class="table table-striped table-bordered table-hover">
      <tr class="spacingtitle" style="height:30px;">
        <td align="center" colspan="2" ><asp:Label ID="lblText" runat="server">添加授权网站</asp:Label></td>
         ...
         <tr><td>授权名称:</td><td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control text_300 required" /></td></tr>
      <tr>
