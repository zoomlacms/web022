<%@ page language="C#" autoeventwireup="true" inherits="Manage_Plus_TxtLog, App_Web_yrc1fd2s" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="del2" OnClientClick="return confirm('确定要删除吗');">删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
