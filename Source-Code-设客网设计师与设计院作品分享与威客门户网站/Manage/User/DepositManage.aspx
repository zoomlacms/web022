<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_DepositManage, App_Web_1jbandww" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExRepeater ID="Deposit_RPT" runat="server" OnItemCommand="Deposit_RPT_ItemCommand" PageSize="10" PagePre="<tr id='page_tr'><td><input type='checkbox' id='chkAll'/></td><td colspan='10' id='page_td'>" PageEnd="</td></tr>">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("Result") %></td>
                    <td>
                        <asp:Button runat="server" CommandName="Check" Text="确认" style="display:none;" CommandArgument='<%#Eval("Y_ID") %>' OnClientClick="return confirm('要确认该笔提现吗?');"></asp:Button>
                        <%#GetOP() %>
                    </td>
                </tr>
            </ItemTemplate>
