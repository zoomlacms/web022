<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Default, App_Web_tupcm2sg" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="oamain">
	<table style="width: 100%;" cellpadding="0" cellspacing="0">
		<tr>
			<td id="toolbar1" style="display:none; width: 260px;" valign="top">
			...
			<td class="switchPoint" style=" width: 10px; background: #ececff;" onclick="hiddendiv()">
				<img id="switchPoint" src="/App_Themes/Admin/butOpen.gif" alt="关闭左栏" />
			</td>
			<td valign="top">
