define(function (require, exports, module) {
    ...
    _self.prototype.Init = function (model) {
        _self.prototype.htmlTlp = '<div id="@id" ng-model="list.@id.dataMod" class="@css" style="@style">';
        switch (model.config.compType) {
            ...
            case "online"://在线视频 embed
                _self.prototype.htmlTlp += "<div class='diy_drag_div'>" + decodeURI(model.config.htmlTlp) + "</div>";
                break;
        }
