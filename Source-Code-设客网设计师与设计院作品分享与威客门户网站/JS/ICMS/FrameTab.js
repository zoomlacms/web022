...
function InitNewFrameTab() {
    $("#newFrameTab").click(function () {
        ...
        $('<li id="iFrameTab' + (++lastFrameTabId) + '" ><a href="javascript:"><span id="frameTabTitle">新选项卡</span><a class="closeTab" title="关闭"><span class="glyphicon glyphicon-remove"></span></a></a></li>').insertBefore(this).iFrameTab();
        frameTabCount++;
