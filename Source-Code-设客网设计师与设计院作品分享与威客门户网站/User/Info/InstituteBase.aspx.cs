...
public partial class User_Info_InstituteBase : CustomerPageAction
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "", "alert('恭喜，保存成功！');location.href='/User/Default.aspx';", true);
			//function.WriteErrMsg("保存成功!");
        }
    }
