<%@ Page Language="C#" MasterPageFile="~/User/Default.master" AutoEventWireup="true" CodeFile="MyMoney.aspx.cs" Inherits="ZoomLa.WebSite.User.Content.MyMoney" %>
...
<asp:TemplateField HeaderText="项目名称" HeaderStyle-CssClass="text-center">
<ItemTemplate>
<%# GetProject(Eval("ItemID", "{0}"))%>
</ItemTemplate>
...
<asp:LinkButton runat="server" CssClass="option_style hidden" CommandName="View" CommandArgument='<%# Eval("GeneralID") %>' Visible='<%#GetIsNRe(Eval("Status", "{0}"),"view") %>' ToolTip="预览"><i class="glyphicon glyphicon-globe"></i>预览</asp:LinkButton>
