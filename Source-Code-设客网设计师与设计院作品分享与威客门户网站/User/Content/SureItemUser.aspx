<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.EditContentpage, App_Web_nj4hhffd" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content ContentPlaceHolderID="head" runat="Server">
<script type="text/javascript" charset="utf-8" src="/Plugins/Ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Plugins/Ueditor/ueditor.all.min.js"></script>
<title>确认中标_<%Call.Label("{$SiteName/}");%></title>
<style>
...
<tr class="show_tr">
<th colspan="2">
<h4 class="text-center">确认中标信息</h4>
</th>
</tr>
<tr class="show_tr">
<td class="text-right">中标人</td>
<td><%Call.Label("{ZL.Label id=\"输出指定用户名\" /}");%></td>
</tr>
...
<asp:Button ID="EBtnSubmit" CssClass="btn btn-success" Text="修改" OnClick="EBtnSubmit_Click" runat="server" OnClientClick="return confirm('是否确认中标信息?');" />
<asp:Button ID="BtnBack" CssClass="btn btn-success" runat="server" Text="返回列表" OnClick="BtnBack_Click" UseSubmitBehavior="False" CausesValidation="False" />
</td>
</tr>
</table>
</div>
...
$().ready(function(e) {
    $(".u_cnt table tr").hide();
    $(".u_cnt table tr.show_tr").show();
	$("#EBtnSubmit").val("确认中标");
	$("#txt_zbr").val("<%Call.Label("{$GetRequest(uid)$}");%>")
