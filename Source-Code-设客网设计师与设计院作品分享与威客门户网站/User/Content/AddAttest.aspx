<%@ Page Title="" Language="C#" MasterPageFile="~/User/Default.master" AutoEventWireup="true" CodeFile="AddAttest.aspx.cs" Inherits="ZoomLa.WebSite.User.Content.AddAttest" ClientIDMode="Static" ValidateRequest="false" %>
...
<tr>
<td colspan="2" class="text-center">添加认证信息</td>
</tr>
<tr hidden>
...
$().ready(function(e) {
	$("#txtTitle").val("设计院<%Call.Label("{ZL:GetuserName()/}");%>的认证信息");
});
</script>
</asp:Content>
