<%@ Page Language="C#" MasterPageFile="~/User/Default.master" AutoEventWireup="true" CodeFile="MyWorks.aspx.cs" Inherits="ZoomLa.WebSite.User.Content.MyWorks" %>
...
<div id="nodeNav" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 padding5 divBorder hidden" style="height:500px;overflow-y:auto;">
<div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding5" id="noderight">
<div class="node13" style="display:none;">
<a href="/User/Content/MyContent.aspx?NodeID=14" class="btn btn-success">概念方案</a>
<a href="/User/Content/MyContent.aspx?NodeID=15" class="btn btn-success">实施方案</a>
<a href="/User/Content/MyContent.aspx?NodeID=16" class="btn btn-success">初步设计</a>
<a href="/User/Content/MyContent.aspx?NodeID=36" class="btn btn-success">施工图设计</a>
<a href="/User/Content/MyContent.aspx?NodeID=38" class="btn btn-success">施工服务</a>
</div>
<div class="nodeadd">
<a id="works27" href="/User/Content/MyWorks.aspx?NodeID=27" class="btn btn-success">住宅</a>
<a id="works28" href="/User/Content/MyWorks.aspx?NodeID=28" class="btn btn-success">酒店</a>
<a id="works29" href="/User/Content/MyWorks.aspx?NodeID=29" class="btn btn-success">办公楼</a>
<a id="works30" href="/User/Content/MyWorks.aspx?NodeID=30" class="btn btn-success">别墅</a>
<a id="works31" href="/User/Content/MyWorks.aspx?NodeID=31" class="btn btn-success">厂房</a>
<a id="works32" href="/User/Content/MyWorks.aspx?NodeID=32" class="btn btn-success">商业</a>
<a id="works33" href="/User/Content/MyWorks.aspx?NodeID=33" class="btn btn-success">医院</a>
<a id="works34" href="/User/Content/MyWorks.aspx?NodeID=34" class="btn btn-success">学校</a>
<a id="works35" href="/User/Content/MyWorks.aspx?NodeID=35" class="btn btn-success">其它</a>
...
$().ready(function(e) {
	var nodeid='<%Call.Label("{$GetRequest(NodeID)$}");%>';
    if(nodeid=="13"||nodeid=="14"||nodeid=="15"||nodeid=="16"||nodeid=="36"||nodeid=="38")
	{
		$(".node13").show();
		$(".nodeadd").hide();
		$("#nodeNav").hide();
		$("#noderight").removeClass("col-lg-10 col-md-10 col-sm-10");
	}
	if(nodeid=='37')
		parent.GoUser();
	if(nodeid=="43")
	{
		$(".nodeadd").remove();
		$(".glyphicon-globe").parent().remove();
	}
	$("#works<%Call.Label("{$GetRequest(NodeID)$}");%>").addClass("btn-danger");
});
</script>
</asp:Content>