<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_odweewxl" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-CN">
<head>
            ...
            <div id="reg_main">
                        ...
                        <ul>
                            <li>
                                <div class="form-group">
                                	<label class="col-lg-3 col-sm-4 col-md-4 col-xs-12 text-right padding0">手机号：</label>
                            ...
                            <li>
                                <div class="form-group">
                                    <label class="col-lg-3 col-sm-4 col-md-4 col-xs-12 text-right padding0">短信验证码：</label>
                                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <li class="text-center">
                                <asp:Button ID="Button1" runat="server" Text="下一步" OnClick="BtnMRegStep1_Click" CssClass="btn btn btn-primary"  />
                            </li>
                        </ul>
                    </div>
                </asp:Panel>
                <asp:Panel ID="PnlRegStep2" runat="server" Visible="false" Width="100%">
                    <div class="border_right">
                        ...
                        <h1 class="text-center"><i class="fa fa-user-plus fa-2x"></i> 注册会员</h1>
                                        ...
                                        <table style="border-collapse: collapse" width="100%"
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <asp:Button ID="BtnSubmit" runat="server" Text="立即注册" CssClass="btn btn-warning btn-block" ValidationGroup="userVaid" OnClick="BtnSubmit_Click"  />
